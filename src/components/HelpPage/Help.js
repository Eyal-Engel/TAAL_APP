...
function Help(props) {
    ...
    const changeHelpText = () => {
        ...
        if (user_tasks.task_location !== null && user_places.places_location !== -1) {
            setState({
                ...state,
                            ...
                            <div className="MobileMode" >
                                <div className="ContentWithLogo">
                                    <div className="helpMe">
                                        <div className="scText"><b>בבקשה,</b></div>
                                        <div className="scText"><b id="Tablet">أحتاج</b></div>
                                        <div className="thanks">
                                            <div id="intro">התקשיתי במילוי המשימות שלי.</div>
                                            <div id="intro">אשמח לסיוע ותודה על הרצון לעזור</div>
                                            <div id="intro" className="Tablet">لو سمحت، أنا أواجه صعوبة في أداء مهماتي ، ارجو أن تساعدني مشكورا</div>
                                        </div>
                                    </div>
                            ...
                            <div className="content">
                                <div className="instructionArea">
                                    <div className="textArea">
                                        ...
                                        {
                                            (user_places.places_location !== -1) && <Fragment>
                                                <div className="headText" hidden={currentTaskName === ''} >המשימה הבאה שלי:</div>
                                                <h2 className="secText" hidden={currentTaskName === ''}>{currentTaskName}</h2>
                                            </Fragment>
                                        }
                    ...
                    <div className="footer">
                        <div className="row">
                            <div className="HelpButton ">
                                <a href={user.user.GuidPhone !== "" ? "tel:" + user.user.GuidPhone : "tel:0502385425"} ><button className="helpNow" onClick={toggleModal}>
                                ...
                                <Modal isOpen={isOpen} onRequestClose={toggleModal} style={styles.modalStyle}>
                                    <div className="popup">
                                        ...
                                        <div className="ModalMessage">
                                            ...
                                            <a href={"tel://" + user.user.GuidPhone}>{user.user.GuidPhone}</a>
                                            <br />
                                            {"ניתן ליצור קשר עם" + " " + user.user.guideName + " " + "לקבלת הנחיות סיוע עד להגעתו/ה"}
                                            <br />
                                            {"תודה על עזרתכם.."}
                                        </div>
                            ...
                            <div className="HelpButton">
                                <button onClick={() => window.history.go(-1)} className="return">
                                    <div className="tabletButton">
                                        <div className="iconD">
